...
INNER JOIN booking_detail ON booking_detail.booking_id = booking.booking_id AND booking.departure_date >= CURRENT_DATE()
INNER JOIN ticket ON ticket.t_id = booking_detail.ticket_id 
INNER JOIN schedule ON schedule.s_id = ticket.schedule_id AND schedule.departure_time <= (schedule.departure_time + INTERVAL 5 HOUR)
